...
embeddings = AzureOpenAIEmbeddings(azure_endpoint=key_param.AZURE_OPENAI_ENDPOINT, 
                                   api_key=key_param.AZURE_OPENAI_API_KEY, 
...
llm = AzureChatOpenAI(azure_endpoint=key_param.AZURE_OPENAI_ENDPOINT, 
...
def query_data(query):
    ...
    # Parameter k sets the number of documents to return 
